...
<div class="container-fluid p-0">
  <!-- Full-width picture -->
    ...
    <div class="col-12 p-0">
      <img src="{{ asset('storage/'. $kalegens->first()->foto) }}" class="post-banner-image" alt="Full-width Picture">
    </div>
  ...
  <div class="container sejarah py-4 mt-5">
    <div class="row">
      <div class="umpak-sumbing col-lg-8 mb-4">
        ...
        <section>
          <h2 class="text-left">{{ $kalegens->first()->nama_desa }}</h2>
          <hr>
          <p>{!! $kalegens->first()->sejarah !!}</p>
        </section>
        ...
        <section>
          ...
          <hr>
          <section>
            <img src="{{ asset('storage/'. $kalegen->foto) }}" class="img-fluid my-3 w-100" alt="Blog Image" style="height: 20rem; object-fit: cover;">
