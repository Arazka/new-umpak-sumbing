...
@section('title', 'Tambah Data Profil Lembaga BKAD')
@section('main')
<div class="container-fluid">
  <!-- Page Heading -->
  <div class="d-sm-flex align-items-center justify-content-between mb-2">
    <h1 class="h3 mb-0 text-gray-800">Tambah Data Profil Lembaga BKAD</h1>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item"><a href="{{ url('admin/profil-lembaga-bkad') }}"> Data Profil Lembaga BKAD</a></li>
        <li class="breadcrumb-item active" aria-current="page">Tambah Data Profil Lembaga BKAD</li>
      </ol>
    </nav>
  </div>
  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      <form method="POST" action="{{ url('/admin/profil-lembaga-bkad') }}">
        @csrf
                <div class="card-body">
