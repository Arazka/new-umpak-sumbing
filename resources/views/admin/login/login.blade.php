                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <img src="{{ asset('img/logo/logo.png') }}" alt="" class="animate__animated animate__backInLeft" style="width:100%; border-radius: 3rem 0 3rem 0">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <span class="small">Copyright &copy; Umpak Sumbing 2023</span>
                                      </div>
                                </div>
                            </div>
                        </div>
