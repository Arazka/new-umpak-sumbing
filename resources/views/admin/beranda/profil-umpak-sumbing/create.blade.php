...
@section('title', 'Tambah Data Profil Umpak Sumbing')
@section('main')
<div class="container-fluid">
  <!-- Page Heading -->
  <div class="d-sm-flex align-items-center justify-content-between mb-2">
    <h1 class="h3 mb-0 text-gray-800">Tambah Data Profil Umpak Sumbing</h1>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item"><a href="{{ url('admin/profile-umpak-sumbing') }}"> Data Profil Umpak Sumbing</a></li>
        <li class="breadcrumb-item active" aria-current="page">Tambah Data Profil Umpak Sumbing</li>
      </ol>
    </nav>
  </div>
  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      <form method="POST" action="{{ url('/admin/profile-umpak-sumbing') }}">
        @csrf
                <div class="card-body">
