...
@section('title', 'Edit Data Wisata Desa Kalegen')
@section('main')
        ...
        @csrf @method('PATCH')
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="judul" id="judul" placeholder="judul" value="{{ old('judul', $kalegen->judul) }}" required>
                        @error('judul')
                        <span class="text-danger">
                          {{ $message }}
                        </span>
