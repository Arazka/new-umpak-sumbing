...
@section('title', 'Lihat Data Wisata Desa Ngepanrejo')
@section('main')
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h3 mb-0 text-gray-800">Lihat Data Wisata Desa Ngepanrejo</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="{{ url('admin/wisata-ngepanrejo') }}">Data Wisata Desa Ngepanrejo</a></li>
              <li class="breadcrumb-item active" aria-current="page">Lihat Data Wisata Desa Ngepanrejo</li>
            </ol>
          </nav>
    </div>
      ...
      <div class="card-body">
        <div class="row">
            <div class="col-12 p-0">
              <img src="{{ asset('img\foto desa\desa ngepanrejo.jpg') }}" class="post-banner-image" alt="Full-width Picture" style="width: 100%">
            </div>
        </div>
            ...
            <div class="row">
              <div class="umpak-sumbing col-lg-8 mb-4">
                ...
                <section>
                  ...
                  <hr>
                  <section>
                    <img src="{{ asset('storage/'.$ngepanrejo->foto) }}" class="img-fluid my-3 w-100" alt="Blog Image" style=" object-fit: cover;">
                    <h3 class="text-left">{{ $ngepanrejo->judul }}</h3>
                    <p>{!! $ngepanrejo->deskripsi !!}</p>
                  </section>
                  @endforeach
                </section>
              </div>
