...
class SidorejoController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.pariwisata.sidorejo.index', ['data' => $sidorejo]);
    }
    ...
    public function view(Request $request)
    {
        ...
        return view('admin.pariwisata.sidorejo.view', ['data' => $sidorejo]);
    }
    ...
    public function create()
    {
        ...
        if (Gate::allows('admin')) {
            return view('admin.pariwisata.sidorejo.create');
        }
    ...
    public function edit($id)
    {
        ...
        $sidorejo = Sidorejo::find($id);
        if (Gate::allows('admin')) {
            return view('admin.pariwisata.sidorejo.edit', compact('sidorejo'));
        }
