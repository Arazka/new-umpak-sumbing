...
class TrasanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.pariwisata.trasan.index', ['data' => $trasan]);
    }
    ...
    public function view(Request $request)
    {
        ...
        return view('admin.pariwisata.trasan.view', ['data' => $trasan]);
    }
    ...
    public function create()
    {
        ...
        if (Gate::allows('admin')) {
            return view('admin.pariwisata.trasan.create');
        }
    ...
    public function edit($id)
    {
        ...
        $trasan = Trasan::find($id);
        if (Gate::allows('admin')) {
            return view('admin.pariwisata.trasan.edit', compact('trasan'));
        }
