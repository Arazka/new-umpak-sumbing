...
class RejosariController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.pariwisata.rejosari.index', ['data' => $rejosari]);
    }
    ...
    public function view(Request $request)
    {
        ...
        return view('admin.pariwisata.rejosari.view', ['data' => $rejosari]);
    }
    ...
    public function create()
    {
        ...
        if (Gate::allows('admin')) {
            return view('admin.pariwisata.rejosari.create');
        }
    ...
    public function edit($id)
    {
        ...
        $rejosari = Rejosari::find($id);
        if (Gate::allows('admin')) {
            return view('admin.pariwisata.rejosari.edit', compact('rejosari'));
        }
