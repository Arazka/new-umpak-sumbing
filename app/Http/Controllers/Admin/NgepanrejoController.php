...
class NgepanrejoController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.pariwisata.ngepanrejo.index', ['data' => $ngepanrejo]);
    }
    ...
    public function view(Request $request)
    {
        ...
        return view('admin.pariwisata.ngepanrejo.view', ['data' => $ngepanrejo]);
    }
    ...
    public function create()
    {
        ...
        if (Gate::allows('admin')) {
            return view('admin.pariwisata.ngepanrejo.create');
        }
    ...
    public function edit($id)
    {
        ...
        $ngepanrejo = Ngepanrejo::find($id);
        if (Gate::allows('admin')) {
            return view('admin.pariwisata.ngepanrejo.edit', compact('ngepanrejo'));
        }
